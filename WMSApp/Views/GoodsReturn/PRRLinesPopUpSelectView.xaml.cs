...
namespace WMSApp.Views.GoodsReturn
{
    ...
    public partial class PRRLinesPopUpSelectView : PopupPage
    {
        ...
        public PRRLinesPopUpSelectView(List<PRR1_Ex> duplicatedItems, string callerAddress)
        {
            InitializeComponent();
            ReturnCallerAddress = callerAddress;
            ItemsSource = new ObservableCollection<PRR1_Ex>(duplicatedItems);
            BindingContext = this;
        }
