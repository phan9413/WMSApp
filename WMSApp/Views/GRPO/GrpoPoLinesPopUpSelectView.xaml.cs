...
namespace WMSApp.Views.GRPO
{
    ...
    public partial class GrpoPoLinesPopUpSelectView : PopupPage
    {
        ...
        public GrpoPoLinesPopUpSelectView(List<POR1_Ex> duplicatedItems, string callerAddress)
        {
            InitializeComponent();
            ReturnCallerAddress = callerAddress;
            ItemsSource = new ObservableCollection<POR1_Ex>(duplicatedItems);
            BindingContext = this;
        } 
