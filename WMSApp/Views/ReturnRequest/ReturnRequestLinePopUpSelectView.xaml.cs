...
namespace WMSApp.Views.ReturnRequest
{
    ...
    public partial class ReturnRequestLinePopUpSelectView : PopupPage
    {
        ...
        public ReturnRequestLinePopUpSelectView(List<DLN1_Ex> duplicatedItems, string callerAddress)
        {
            InitializeComponent();
            ReturnCallerAddress = callerAddress;
            ItemsSource = new ObservableCollection<DLN1_Ex>(duplicatedItems);
            BindingContext = this;
        }
