...
namespace WMSApp.Views.DO
{
    ...
    public partial class DoSoLinesPopUpSelectView : PopupPage
    {
        ...
        public DoSoLinesPopUpSelectView(List<RDR1_Ex> duplicatedItems, string callerAddress)
        {
            InitializeComponent();
            ReturnCallerAddress = callerAddress;
            ItemsSource = new ObservableCollection<RDR1_Ex>(duplicatedItems);
            BindingContext = this;
        }
