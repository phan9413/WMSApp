...
{
    public class PDN1_Ex : PDN1, INotifyPropertyChanged
    {
        ...
        public string DocNum => $"{GRN.DocNum}";
        public string CardName => $"{GRN.CardName}";
        public string CardCode => $"{GRN.CardCode}";

        readonly string _SelectBaseWarehouse = "_SelectBaseWarehouse20201113T1043_GRR";
